...
def load_env():
    ...
    defaults = {
        ...
        'SUPPLY_URL': 'http://10.10.0.40:8109',
        'NETSCALER_URL': 'http://10.10.0.40:8121',
        'SOCNETSCALER_URL': 'http://10.10.0.40:8120',
...
def collect_metrics():
    ...
    extra_services = {
        ...
        'supply':       CONFIG['SUPPLY_URL'].rstrip('/'),
        'netscaler':    CONFIG['NETSCALER_URL'].rstrip('/'),
        'socnetscaler': CONFIG['SOCNETSCALER_URL'].rstrip('/'),
...
class Handler(http.server.SimpleHTTPRequestHandler):
    ...
    def _serve_dashboard(self):
        ...
        replacements = {
            ...
            '{{SUPPLY_URL}}':     CONFIG['SUPPLY_URL'],
            '{{NETSCALER_URL}}':  CONFIG['NETSCALER_URL'],
            '{{SOCNETSCALER_URL}}': CONFIG['SOCNETSCALER_URL'],
